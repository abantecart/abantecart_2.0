					...
					<v-container>
						...
						<v-layout>
                            <v-flex xs12 sm4 style="text-align: center;">
                                <v-btn color="primary" @click="applyFilter()" v-bind:disabled="clearFilterDisabled">
                                    Apply Filter
                                </v-btn>
                            </v-flex>
                            <v-flex xs12 sm4 style="text-align: center;">
                                <v-btn color="error" @click="clearFilter()" v-bind:disabled="clearFilterDisabled">Clear
                                    Filter
                                </v-btn>
							</v-flex>
                            <v-flex xs12 sm4 style="text-align: center;">
							...
							>
                                <template slot="item" slot-scope="props">
                                    <tr @click="expandFunction(props)">
                                        <td v-for="table_header in table_headers" :width="table_header.width"
                                            :title="props.item[table_header.value]">
                                                    ...
                                                    <template slot="item" slot-scope="expand_props">
                                                        <tr>
                                                            <td v-for="expand_header in expand_headers"
                                                                :title="expand_props.item[expand_header.value]">
