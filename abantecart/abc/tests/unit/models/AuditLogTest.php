...
class AuditLogTest extends ATestCase
{
    public function setUp(): void
    {
        ...
        $db = Registry::db();
        $db->query(
            "DELETE FROM ".$db->table_name('products')." 
            WHERE product_id IN 
                (SELECT product_id 
                FROM ".$db->table_name('product_descriptions')." 
                WHERE name IN ('Test product', 'Test update product'))"
        );
    }

    //TODO: NEED TO FIX AUDIT LOGGING DATABASE FIRST!
