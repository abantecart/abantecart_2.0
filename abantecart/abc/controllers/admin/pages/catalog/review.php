...
class ControllerPagesCatalogReview extends AController
{
    ...
    public $error = [];
    protected $fields = ['status', 'rating', 'text', 'author'];
    ...
    public function main()
    {
        ...
        $grid_search_form['fields']['product_id'] = $form->getFieldHtml([
            ...
            'options' => ['' => $this->language->get('text_select_product')]
    ...
    protected function _getForm()
    {
        ...
        if ($productInfo) {
            $this->data['product'] = $productInfo['name'];
            $this->data['preview'] = $this->html->getCatalogURL('product/product', '&product_id=' . $productId);
        } else {
        ...
        $this->data['products'] = [0 => $this->language->get('text_select_product')];
        $this->data['products'][$productId] = $productInfo['name'];
