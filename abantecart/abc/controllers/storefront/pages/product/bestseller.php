...
class ControllerPagesProductBestSeller extends AController
{
    ...
    public function main()
    {
        ...
        $this->setBreadCrumbs($this->getSelfUrl('product/bestseller'));

        /** @see Product::getProducts() */
        $productList = Product::getBestSellerProducts($this->data['search_parameters']);
        ...
        if ($productTotal) {
            ...
            $this->setPagination('product/bestseller', $productTotal);
