...
(
    ...
    `sent_to_address`  text COLLATE utf8_general_ci         NOT NULL DEFAULT '',
    `date_added`       timestamp                            NULL     DEFAULT CURRENT_TIMESTAMP,
    `date_modified`    timestamp                            NULL     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
ALTER TABLE `ac_addresses`
    CHANGE COLUMN `company` `company` VARCHAR(255) NOT NULL DEFAULT '',
...
(
    ...
    `text_id`              varchar(255) COLLATE utf8_general_ci NOT NULL,
    `language_id`          int(11)                              NOT NULL,
    `headers`              varchar(255) COLLATE utf8_general_ci NOT NULL,
    `subject`              varchar(255) COLLATE utf8_general_ci NOT NULL,
    `html_body`            text COLLATE utf8_general_ci         NOT NULL,
    `text_body`            text COLLATE utf8_general_ci         NOT NULL,
    `allowed_placeholders` text COLLATE utf8_general_ci         NOT NULL,
    `date_added`           timestamp                            NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
VALUES (1, 1, 'storefront_reset_password_link', 1, '', '{{store_name}} - Password reset',
        'A password reset was requested from {{store_name}}&lt;br /&gt;\r\nTo reset your password click link below:&lt;br /&gt;\r\n{{ reset_link }}\r\n\r\n',
        'A password reset was requested from {{store_name}} \r\nTo reset your password click link below:\r\n{{ reset_link }}',
        'store_name, reset_link', '2019-12-18 13:26:38', '2019-12-19 13:28:01', NULL),
       (2, 1, 'storefront_welcome_email_activated', 1, '', 'Welcome, {{store_name}}',
        ...
        'store_name, login_url, store_url, logo_html, logo_uri', '2019-12-19 13:59:34', '2019-12-20 08:58:07', NULL),
       (3, 1, 'storefront_welcome_email_approval', 1, '', 'Welcome, {{store_name}}',
        ...
        'store_name, login_url, store_url, logo_html, logo_uri', '2019-12-20 09:02:19', '2019-12-20 09:08:29', NULL),
       (4, 1, 'storefront_send_activate_link', 1, '', '{{store_name}} - Thank you for registering',
        ...
        'store_name, activate_url, logo_uri, logo_html, store_url', '2019-12-20 10:05:55', '2019-12-20 10:14:56', NULL),
       (5, 1, 'storefront_reset_password_notify', 1, '', '{{store_name}} - Password reset',
        'Your password was successfully reset on {{store_name}}',
        'Your password was successfully reset on {{store_name}}', 'store_name', '2019-12-20 10:30:10',
        '2019-12-20 10:30:10', NULL),
       (6, 1, 'storefront_send_login_name', 1, '', '{{store_name}} - Login name reminder',
        'Login name reminder was requested from {{store_name}} &lt;br/&gt;\r\n&lt;br/&gt;\r\nYour login name is: {{ login_name }}',
        'Login name reminder was requested from {{store_name}} \r\n\r\nYour login name is: {{ login_name }}',
        'store_name, login_name', '2019-12-20 10:37:18', '2019-12-20 10:37:18', NULL),
       (7, 1, 'storefront_order_confirm', 1, '', '{{store_name}} - Order {{ order_number }}',
        ...
        'store_name, order_number, store_url, logo_uri, logo_html, date_added, payment_method, shipping_method, customer_email, customer_telephone, customer_mobile_phone, customer_fax, customer_ip, shipping_data, payment_data, products, totals, comment, invoice,  text_project_label, ',
        '2019-12-23 07:23:50', '2019-12-23 10:02:38', NULL),
       (8, 1, 'storefront_order_confirm_alert', 1, '', '{{store_name}} - Order {{ order_number }} ({{ order_total }})',
        '&lt;html&gt;\r\n&lt;head&gt;\r\n	&lt;meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"&gt;\r\n	&lt;title&gt; {{store_name}} - Order {{ order_number }} &lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;\r\n&lt;table style=\"font-family: Verdana,sans-serif; font-size: 11px; color: #374953; width: 600px;\"&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;\r\n				&lt;a href=\"{{ store_url }}\" title=\"{{ store_name }}\"&gt;\r\n						{{# logo_uri}}\r\n							&lt;img src=\"{{ logo_uri }}\" alt=\"{{store_name}}\" style=\"border: none;\"&gt;\r\n                                                 {{/ logo_uri}}\r\n                                                 {{^ logo_uri}}\r\n                                                       {{# logo_html}}\r\n                                                        {{logo_html}}\r\n                                                       {{/ logo_html}}\r\n                                                 {{/ logo_uri}}\r\n					&lt;/a&gt;\r\n				&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;You have received an order.&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"\r\n		    style=\"background-color: #069; color:#FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;Order Details&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;Order ID: &lt;span\r\n					style=\"color: #069; font-weight: bold;\"&gt;{{ order_number }}&lt;/span&gt;&lt;br/&gt;\r\n			Date Ordered: {{ date_added }}&lt;br&gt;\r\n			Payment Method: &lt;strong&gt;{{ payment_method }}&lt;/strong&gt;&lt;br/&gt;\r\n			Shipping Method: &lt;strong&gt;{{ shipping_method }}&lt;/strong&gt;&lt;br/&gt;\r\n			&lt;br/&gt;\r\n			Email: &lt;strong&gt;{{ customer_email }}&lt;/strong&gt;&lt;br/&gt;\r\n			Telephone: &lt;strong&gt;{{ customer_telephone }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{# customer_mobile_phone }}\r\n                            Telephone: &lt;strong&gt;{{ customer_mobile_phone }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{/ customer_mobile_phone }}\r\n		         {{# customer_fax }}\r\n                            Fax: &lt;strong&gt;{{ customer_fax }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{/ customer_fax }}\r\n                         IP Address:&lt;strong&gt;{{ customer_ip }}&lt;/strong&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;\r\n			&lt;table style=\"width: 100%; font-family: Verdana,sans-serif; font-size: 11px; color: #FFFFFF;\"&gt;\r\n		&lt;tr style=\"background-color: #CCCCCC; text-transform: uppercase;\"&gt;\r\n					&lt;th style=\"text-align: left; padding: 0.3em;\"&gt;Shipping Address&lt;/th&gt;\r\n		&lt;th style=\"text-align: left; padding: 0.3em;\"&gt;Payment Address&lt;/th&gt;\r\n				&lt;/tr&gt;\r\n				&lt;tr&gt;\r\n					&lt;td style=\"padding: 0.3em; background-color: #EEEEEE; color: #000;\"&gt;\r\n{{# shipping_data }}\r\n{{ firstname }} {{lastname}} &lt;br/&gt;\r\n{{# company }}\r\n{{ company }} &lt;br/&gt; \r\n{{/ company }}\r\n{{# address_1 }}\r\n{{ address_1 }} &lt;br/&gt; \r\n{{/ address_1 }}\r\n{{# address_2 }}\r\n{{ address_2 }} &lt;br/&gt; \r\n{{/ address_2 }}\r\n{{ city }} {{ postcode }} &lt;br/&gt; \r\n{{# zone }}\r\n{{ zone }} &lt;br/&gt; \r\n{{/ zone }}\r\n{{ country }}\r\n{{/ shipping_data }}\r\n&lt;/td&gt;\r\n					&lt;td style=\"padding: 0.3em; background-color: #EEEEEE; color: #000;\"&gt;\r\n{{# payment_data }}\r\n{{ firstname }} {{lastname}} &lt;br/&gt;\r\n{{# company }}\r\n{{ company }} &lt;br/&gt; \r\n{{/ company }}\r\n{{# address_1 }}\r\n{{ address_1 }} &lt;br/&gt; \r\n{{/ address_1 }}\r\n{{# address_2 }}\r\n{{ address_2 }} &lt;br/&gt; \r\n{{/ address_2 }}\r\n{{ city }} {{ postcode }} &lt;br/&gt; \r\n{{# zone }}\r\n{{ zone }} &lt;br/&gt; \r\n{{/ zone }}\r\n{{ country }}\r\n{{/ payment_data }}\r\n&lt;/td&gt;\r\n				&lt;/tr&gt;\r\n			&lt;/table&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;\r\n			&lt;table style=\"width: 100%; font-family: Verdana,sans-serif; font-size: 11px; color: #000000;\"&gt;\r\n				&lt;tr style=\"background-color: #CCCCCC;\"&gt;\r\n					&lt;th style=\"width: 40%; padding: 0.3em; color: #FFFFFF;\"&gt;Product&lt;/th&gt;\r\n					&lt;th class=\"align_left\" style=\"color: #FFFFFF;\"&gt;Model&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n		    style=\"width: 10%; padding: 0.3em; color: #FFFFFF;\"&gt;Price&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n					    style=\"width: 15%; padding: 0.3em; color: #FFFFFF;\"&gt;Quantity&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n					    style=\"width: 20%; padding: 0.3em; color: #FFFFFF;\"&gt;Total&lt;/th&gt;\r\n				&lt;/tr&gt;\r\n				{{# products }}\r\n					&lt;tr style=\"background-color: #EEEEEE; text-align: center;\"&gt;\r\n						&lt;td class=\"align_left\" style=\"text-align: left;\"&gt;{{ name }}\r\n					{{# option }}\r\n								&lt;br/&gt;\r\n								&amp;nbsp;&amp;nbsp;- {{ name}} {{ value }} \r\n	{{/ option }}\r\n						&lt;td class=\"align_left\"&gt; {{ model }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ price }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ quantity }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ total }}&lt;/td&gt;\r\n					&lt;/tr&gt;\r\n                                {{/ products }}\r\n                                         {{# totals }}\r\n			&lt;tr style=\"text-align: right;\"&gt;\r\n						&lt;td colspan=\"3\"&gt;&amp;nbsp;&lt;/td&gt;\r\n						&lt;td style=\"background-color: #EEEEEE; font-weight: bold; padding: 0.3em;\"&gt;{{ title }} &lt;/td&gt;\r\n						&lt;td style=\"background-color: #EEEEEE; padding: 0.3em;\"&gt; {{ text }}&lt;/td&gt;\r\n					&lt;/tr&gt;\r\n                                         {{/ totals }}\r\n			&lt;/table&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"\r\n		    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n {{# comment }}\r\n	&lt;tr&gt;\r\n			&lt;td class=\"align_left\"\r\n			    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;The comments for your order are:&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"&gt; {{ comment }} &lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n {{/ comment }}\r\n {{# invoice }}\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"\r\n			    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;To view your order click on the link below:&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"&gt;&lt;a href=\"{{ invoice }}\"&gt; {{ invoice }}&lt;/a&gt;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n{{/ invoice }}\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_center\"\r\n		    style=\"font-size: 10px; border-top: 1px solid #069; text-decoration: none; color: #374953;\"&gt;\r\n			&lt;a href=\"{{ store_url }}\"\r\n			   style=\"color: #069; font-weight: bold; text-decoration: none;\"&gt;{{ store_name }}&lt;/a&gt;\r\n{{ text_project_label }}\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n&lt;/table&gt;\r\n&lt;/body&gt;\r\n&lt;/html&gt;\r\n',
        'You have received an order.\r\n\r\nOrder Details\r\n\r\nOrder ID: {{ order_number }}\r\nDate Ordered: {{ date_added }}\r\nPayment Method: {{ payment_method }}\r\nShipping Method: {{ shipping_method }}\r\n\r\nEmail: {{ customer_email }}\r\nTelephone: {{ customer_telephone }}\r\n{{# customer_mobile_phone }}\r\nTelephone: {{ customer_mobile_phone }}\r\n{{/ customer_mobile_phone }}\r\n{{# customer_fax }}\r\nFax: {{ customer_fax }}\r\n{{/ customer_fax }}\r\nIP Address: {{ customer_ip }}\r\n\r\n{{# shipping_data }}\r\nShipping Address:\r\n{{ firstname }} {{lastname}}\r\n{{ company }} \r\n{{ address_1 }} \r\n{{ address_2 }}\r\n{{ city }} {{ postcode }}\r\n{{ zone }}\r\n{{ country }}\r\n{{/ shipping_data }}\r\n\r\n{{# payment_data }}\r\nPayment Address:\r\n{{ firstname }} {{lastname}} \r\n{{ company }}\r\n{{ address_1 }}\r\n{{ address_2 }}\r\n{{ city }} {{ postcode }}\r\n{{ zone }}\r\n{{ country }}\r\n{{/ payment_data }}\r\n\r\n\r\nProduct                                                 Model                             Price                  Quantity              Total\r\n{{# products }}\r\n					\r\n{{ name }}                                               {{ model }}                       {{ price }}            {{ quantity }}        {{ total }}\r\n   {{# option }}\r\n    - {{ name}} {{ value }} \r\n   {{/ option }}\r\n\r\n\r\n{{/ products }}\r\n{{# totals }}\r\n  {{ title }}  {{ text }}\r\n{{/ totals }}\r\n\r\n\r\n{{# comment }}\r\n	The comments for your order are:\r\n {{ comment }} \r\n{{/ comment }}\r\n\r\n{{# invoice }}\r\nTo view your order click on the link below:\r\n{{ invoice }}\r\n{{/ invoice }}\r\n\r\n{{ store_name }}\r\n{{ text_project_label }}',
        'store_name, order_number, store_url, logo_uri, logo_html, date_added, payment_method, shipping_method, customer_email, customer_telephone, customer_mobile_phone, customer_fax, customer_ip, shipping_data, payment_data, products, totals, comment, invoice,  text_project_label, order_total',
        '2019-12-23 10:33:00', '2019-12-23 10:38:37', NULL),
       (9, 1, 'admin_order_update_product_statuses', 1, '', '{{ store_name }} - Order Update {{ order_id }}',
        '&lt;html&gt;\r\n&lt;head&gt;\r\n	&lt;meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"&gt;\r\n	&lt;title&gt; {{store_name}} - Order {{ order_number }} &lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;\r\n&lt;table style=\"font-family: Verdana,sans-serif; font-size: 11px; color: #374953; width: 600px;\"&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;\r\n					&lt;a href=\"{{ store_url }}\" title=\"{{ store_name }}\"&gt;\r\n				{{# logo_uri}}\r\n							&lt;img src=\"{{ logo_uri }}\" alt=\"{{store_name}}\" style=\"border: none;\"&gt;\r\n                                                 {{/ logo_uri}}\r\n                                                 {{^ logo_uri}}\r\n                                                       {{# logo_html}}\r\n                                                        {{logo_html}}\r\n                                                       {{/ logo_html}}\r\n                                                 {{/ logo_uri}}\r\n					&lt;/a&gt;\r\n				&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;Thank you for your interest in {{store_name}} products. Your order has been received and will be processed after payment is confirmed.&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"\r\n		    style=\"background-color: #069; color:#FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;Order Details&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;Order ID: &lt;span\r\n					style=\"color: #069; font-weight: bold;\"&gt;{{ order_number }}&lt;/span&gt;&lt;br/&gt;\r\n			Date Ordered: {{ date_added }}&lt;br&gt;\r\n			Payment Method: &lt;strong&gt;{{ payment_method }}&lt;/strong&gt;&lt;br/&gt;\r\n			Shipping Method: &lt;strong&gt;{{ shipping_method }}&lt;/strong&gt;&lt;br/&gt;\r\n			&lt;br/&gt;\r\n			Email: &lt;strong&gt;{{ customer_email }}&lt;/strong&gt;&lt;br/&gt;\r\n			Telephone: &lt;strong&gt;{{ customer_telephone }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{# customer_mobile_phone }}\r\n                            Telephone: &lt;strong&gt;{{ customer_mobile_phone }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{/ customer_mobile_phone }}\r\n		         {{# customer_fax }}\r\n                            Fax: &lt;strong&gt;{{ customer_fax }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{/ customer_fax }}\r\n                         IP Address:&lt;strong&gt;{{ customer_ip }}&lt;/strong&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;\r\n			&lt;table style=\"width: 100%; font-family: Verdana,sans-serif; font-size: 11px; color: #FFFFFF;\"&gt;\r\n		&lt;tr style=\"background-color: #CCCCCC; text-transform: uppercase;\"&gt;\r\n					&lt;th style=\"text-align: left; padding: 0.3em;\"&gt;Shipping Address&lt;/th&gt;\r\n		&lt;th style=\"text-align: left; padding: 0.3em;\"&gt;Payment Address&lt;/th&gt;\r\n				&lt;/tr&gt;\r\n				&lt;tr&gt;\r\n					&lt;td style=\"padding: 0.3em; background-color: #EEEEEE; color: #000;\"&gt;\r\n{{# shipping_data }}\r\n{{ firstname }} {{lastname}} &lt;br/&gt;\r\n{{# company }}\r\n{{ company }} &lt;br/&gt; \r\n{{/ company }}\r\n{{# address_1 }}\r\n{{ address_1 }} &lt;br/&gt; \r\n{{/ address_1 }}\r\n{{# address_2 }}\r\n{{ address_2 }} &lt;br/&gt; \r\n{{/ address_2 }}\r\n{{ city }} {{ postcode }} &lt;br/&gt; \r\n{{# zone }}\r\n{{ zone }} &lt;br/&gt; \r\n{{/ zone }}\r\n{{ country }}\r\n{{/ shipping_data }}\r\n&lt;/td&gt;\r\n					&lt;td style=\"padding: 0.3em; background-color: #EEEEEE; color: #000;\"&gt;\r\n{{# payment_data }}\r\n{{ firstname }} {{lastname}} &lt;br/&gt;\r\n{{# company }}\r\n{{ company }} &lt;br/&gt; \r\n{{/ company }}\r\n{{# address_1 }}\r\n{{ address_1 }} &lt;br/&gt; \r\n{{/ address_1 }}\r\n{{# address_2 }}\r\n{{ address_2 }} &lt;br/&gt; \r\n{{/ address_2 }}\r\n{{ city }} {{ postcode }} &lt;br/&gt; \r\n{{# zone }}\r\n{{ zone }} &lt;br/&gt; \r\n{{/ zone }}\r\n{{ country }}\r\n{{/ payment_data }}\r\n&lt;/td&gt;\r\n				&lt;/tr&gt;\r\n			&lt;/table&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;\r\n			&lt;table style=\"width: 100%; font-family: Verdana,sans-serif; font-size: 11px; color: #000000;\"&gt;\r\n				&lt;tr style=\"background-color: #CCCCCC;\"&gt;\r\n					&lt;th style=\"width: 40%; padding: 0.3em; color: #FFFFFF;\"&gt;Product&lt;/th&gt;\r\n					&lt;th class=\"align_left\" style=\"color: #FFFFFF;\"&gt;Model&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n		    style=\"width: 10%; padding: 0.3em; color: #FFFFFF;\"&gt;Price&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n					    style=\"width: 15%; padding: 0.3em; color: #FFFFFF;\"&gt;Quantity&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n					    style=\"width: 20%; padding: 0.3em; color: #FFFFFF;\"&gt;Total&lt;/th&gt;\r\n				&lt;/tr&gt;\r\n				{{# products }}\r\n					&lt;tr style=\"background-color: #EEEEEE; text-align: center;\"&gt;\r\n						&lt;td class=\"align_left\" style=\"text-align: left;\"&gt;{{ name }}\r\n					{{# option }}\r\n								&lt;br/&gt;\r\n								&amp;nbsp;&amp;nbsp;- {{ name}} {{ value }} \r\n	{{/ option }}\r\n						&lt;td class=\"align_left\"&gt; {{ model }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ price }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ quantity }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ total }}&lt;/td&gt;\r\n					&lt;/tr&gt;\r\n                                {{/ products }}\r\n                                         {{# totals }}\r\n			&lt;tr style=\"text-align: right;\"&gt;\r\n						&lt;td colspan=\"3\"&gt;&amp;nbsp;&lt;/td&gt;\r\n						&lt;td style=\"background-color: #EEEEEE; font-weight: bold; padding: 0.3em;\"&gt;{{ title }} &lt;/td&gt;\r\n						&lt;td style=\"background-color: #EEEEEE; padding: 0.3em;\"&gt; {{ text }}&lt;/td&gt;\r\n					&lt;/tr&gt;\r\n                                         {{/ totals }}\r\n			&lt;/table&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"\r\n		    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n {{# comment }}\r\n	&lt;tr&gt;\r\n			&lt;td class=\"align_left\"\r\n			    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;The comments for your order are:&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"&gt; {{ comment }} &lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n {{/ comment }}\r\n {{# invoice }}\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"\r\n			    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;To view your order click on the link below:&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"&gt;&lt;a href=\"{{ invoice }}\"&gt; {{ invoice }}&lt;/a&gt;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n{{/ invoice }}\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_center\"\r\n		    style=\"font-size: 10px; border-top: 1px solid #069; text-decoration: none; color: #374953;\"&gt;\r\n			&lt;a href=\"{{ store_url }}\"\r\n			   style=\"color: #069; font-weight: bold; text-decoration: none;\"&gt;{{ store_name }}&lt;/a&gt;\r\n{{ text_project_label }}\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n&lt;/table&gt;\r\n&lt;/body&gt;\r\n&lt;/html&gt;\r\n',
        'Thank you for your interest in {{store_name}} products. Your order has been received and will be processed after payment is confirmed.\r\n\r\nOrder Details\r\n\r\nOrder ID: {{ order_number }}\r\nDate Ordered: {{ date_added }}\r\nPayment Method: {{ payment_method }}\r\nShipping Method: {{ shipping_method }}\r\n\r\nEmail: {{ customer_email }}\r\nTelephone: {{ customer_telephone }}\r\n{{# customer_mobile_phone }}\r\nTelephone: {{ customer_mobile_phone }}\r\n{{/ customer_mobile_phone }}\r\n{{# customer_fax }}\r\nFax: {{ customer_fax }}\r\n{{/ customer_fax }}\r\nIP Address: {{ customer_ip }}\r\n\r\n{{# shipping_data }}\r\nShipping Address:\r\n{{ firstname }} {{lastname}}\r\n{{ company }} \r\n{{ address_1 }} \r\n{{ address_2 }}\r\n{{ city }} {{ postcode }}\r\n{{ zone }}\r\n{{ country }}\r\n{{/ shipping_data }}\r\n\r\n{{# payment_data }}\r\nPayment Address:\r\n{{ firstname }} {{lastname}} \r\n{{ company }}\r\n{{ address_1 }}\r\n{{ address_2 }}\r\n{{ city }} {{ postcode }}\r\n{{ zone }}\r\n{{ country }}\r\n{{/ payment_data }}\r\n\r\n\r\nProduct                                                 Model                             Price                  Quantity              Total\r\n{{# products }}\r\n					\r\n{{ name }}                                               {{ model }}                       {{ price }}            {{ quantity }}        {{ total }}\r\n   {{# option }}\r\n    - {{ name}} {{ value }} \r\n   {{/ option }}\r\n\r\n\r\n{{/ products }}\r\n{{# totals }}\r\n  {{ title }}  {{ text }}\r\n{{/ totals }}\r\n\r\n\r\n{{# comment }}\r\n	The comments for your order are:\r\n {{ comment }} \r\n{{/ comment }}\r\n\r\n{{# invoice }}\r\nTo view your order click on the link below:\r\n{{ invoice }}\r\n{{/ invoice }}\r\n\r\n{{ store_name }}\r\n{{ text_project_label }}',
        'store_name, order_number, store_url, logo_uri, logo_html, date_added, payment_method, shipping_method, customer_email, customer_telephone, customer_mobile_phone, customer_fax, customer_ip, shipping_data, payment_data, products, totals, comment, invoice,  text_project_label, ',
        '2019-12-23 13:11:55', '2019-12-23 13:12:48', NULL),
       (10, 1, 'admin_order_update_product_statuses_alert', 1, '', '{{ store_name }} - Order Update {{ order_id }}',
        '&lt;html&gt;\r\n&lt;head&gt;\r\n	&lt;meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"&gt;\r\n	&lt;title&gt; {{store_name}} - Order {{ order_number }} &lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;\r\n&lt;table style=\"font-family: Verdana,sans-serif; font-size: 11px; color: #374953; width: 600px;\"&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;\r\n				&lt;a href=\"{{ store_url }}\" title=\"{{ store_name }}\"&gt;\r\n						{{# logo_uri}}\r\n							&lt;img src=\"{{ logo_uri }}\" alt=\"{{store_name}}\" style=\"border: none;\"&gt;\r\n                                                 {{/ logo_uri}}\r\n                                                 {{^ logo_uri}}\r\n                                                       {{# logo_html}}\r\n                                                        {{logo_html}}\r\n                                                       {{/ logo_html}}\r\n                                                 {{/ logo_uri}}\r\n					&lt;/a&gt;\r\n				&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;You have received an order.&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"\r\n		    style=\"background-color: #069; color:#FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;Order Details&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;Order ID: &lt;span\r\n					style=\"color: #069; font-weight: bold;\"&gt;{{ order_number }}&lt;/span&gt;&lt;br/&gt;\r\n			Date Ordered: {{ date_added }}&lt;br&gt;\r\n			Payment Method: &lt;strong&gt;{{ payment_method }}&lt;/strong&gt;&lt;br/&gt;\r\n			Shipping Method: &lt;strong&gt;{{ shipping_method }}&lt;/strong&gt;&lt;br/&gt;\r\n			&lt;br/&gt;\r\n			Email: &lt;strong&gt;{{ customer_email }}&lt;/strong&gt;&lt;br/&gt;\r\n			Telephone: &lt;strong&gt;{{ customer_telephone }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{# customer_mobile_phone }}\r\n                            Telephone: &lt;strong&gt;{{ customer_mobile_phone }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{/ customer_mobile_phone }}\r\n		         {{# customer_fax }}\r\n                            Fax: &lt;strong&gt;{{ customer_fax }}&lt;/strong&gt;&lt;br/&gt;\r\n                         {{/ customer_fax }}\r\n                         IP Address:&lt;strong&gt;{{ customer_ip }}&lt;/strong&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;\r\n			&lt;table style=\"width: 100%; font-family: Verdana,sans-serif; font-size: 11px; color: #FFFFFF;\"&gt;\r\n		&lt;tr style=\"background-color: #CCCCCC; text-transform: uppercase;\"&gt;\r\n					&lt;th style=\"text-align: left; padding: 0.3em;\"&gt;Shipping Address&lt;/th&gt;\r\n		&lt;th style=\"text-align: left; padding: 0.3em;\"&gt;Payment Address&lt;/th&gt;\r\n				&lt;/tr&gt;\r\n				&lt;tr&gt;\r\n					&lt;td style=\"padding: 0.3em; background-color: #EEEEEE; color: #000;\"&gt;\r\n{{# shipping_data }}\r\n{{ firstname }} {{lastname}} &lt;br/&gt;\r\n{{# company }}\r\n{{ company }} &lt;br/&gt; \r\n{{/ company }}\r\n{{# address_1 }}\r\n{{ address_1 }} &lt;br/&gt; \r\n{{/ address_1 }}\r\n{{# address_2 }}\r\n{{ address_2 }} &lt;br/&gt; \r\n{{/ address_2 }}\r\n{{ city }} {{ postcode }} &lt;br/&gt; \r\n{{# zone }}\r\n{{ zone }} &lt;br/&gt; \r\n{{/ zone }}\r\n{{ country }}\r\n{{/ shipping_data }}\r\n&lt;/td&gt;\r\n					&lt;td style=\"padding: 0.3em; background-color: #EEEEEE; color: #000;\"&gt;\r\n{{# payment_data }}\r\n{{ firstname }} {{lastname}} &lt;br/&gt;\r\n{{# company }}\r\n{{ company }} &lt;br/&gt; \r\n{{/ company }}\r\n{{# address_1 }}\r\n{{ address_1 }} &lt;br/&gt; \r\n{{/ address_1 }}\r\n{{# address_2 }}\r\n{{ address_2 }} &lt;br/&gt; \r\n{{/ address_2 }}\r\n{{ city }} {{ postcode }} &lt;br/&gt; \r\n{{# zone }}\r\n{{ zone }} &lt;br/&gt; \r\n{{/ zone }}\r\n{{ country }}\r\n{{/ payment_data }}\r\n&lt;/td&gt;\r\n				&lt;/tr&gt;\r\n			&lt;/table&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"&gt;\r\n			&lt;table style=\"width: 100%; font-family: Verdana,sans-serif; font-size: 11px; color: #000000;\"&gt;\r\n				&lt;tr style=\"background-color: #CCCCCC;\"&gt;\r\n					&lt;th style=\"width: 40%; padding: 0.3em; color: #FFFFFF;\"&gt;Product&lt;/th&gt;\r\n					&lt;th class=\"align_left\" style=\"color: #FFFFFF;\"&gt;Model&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n		    style=\"width: 10%; padding: 0.3em; color: #FFFFFF;\"&gt;Price&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n					    style=\"width: 15%; padding: 0.3em; color: #FFFFFF;\"&gt;Quantity&lt;/th&gt;\r\n					&lt;th class=\"align_right\"\r\n					    style=\"width: 20%; padding: 0.3em; color: #FFFFFF;\"&gt;Total&lt;/th&gt;\r\n				&lt;/tr&gt;\r\n				{{# products }}\r\n					&lt;tr style=\"background-color: #EEEEEE; text-align: center;\"&gt;\r\n						&lt;td class=\"align_left\" style=\"text-align: left;\"&gt;{{ name }}\r\n					{{# option }}\r\n								&lt;br/&gt;\r\n								&amp;nbsp;&amp;nbsp;- {{ name}} {{ value }} \r\n	{{/ option }}\r\n						&lt;td class=\"align_left\"&gt; {{ model }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ price }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ quantity }} &lt;/td&gt;\r\n						&lt;td class=\"align_right\"&gt; {{ total }}&lt;/td&gt;\r\n					&lt;/tr&gt;\r\n                                {{/ products }}\r\n                                         {{# totals }}\r\n			&lt;tr style=\"text-align: right;\"&gt;\r\n						&lt;td colspan=\"3\"&gt;&amp;nbsp;&lt;/td&gt;\r\n						&lt;td style=\"background-color: #EEEEEE; font-weight: bold; padding: 0.3em;\"&gt;{{ title }} &lt;/td&gt;\r\n						&lt;td style=\"background-color: #EEEEEE; padding: 0.3em;\"&gt; {{ text }}&lt;/td&gt;\r\n					&lt;/tr&gt;\r\n                                         {{/ totals }}\r\n			&lt;/table&gt;\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_left\"\r\n		    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n	&lt;tr&gt;\r\n		&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n {{# comment }}\r\n	&lt;tr&gt;\r\n			&lt;td class=\"align_left\"\r\n			    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;The comments for your order are:&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"&gt; {{ comment }} &lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n {{/ comment }}\r\n {{# invoice }}\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"\r\n			    style=\"background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;\"&gt;To view your order click on the link below:&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td class=\"align_left\"&gt;&lt;a href=\"{{ invoice }}\"&gt; {{ invoice }}&lt;/a&gt;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;&amp;nbsp;&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n{{/ invoice }}\r\n	&lt;tr&gt;\r\n		&lt;td class=\"align_center\"\r\n		    style=\"font-size: 10px; border-top: 1px solid #069; text-decoration: none; color: #374953;\"&gt;\r\n			&lt;a href=\"{{ store_url }}\"\r\n			   style=\"color: #069; font-weight: bold; text-decoration: none;\"&gt;{{ store_name }}&lt;/a&gt;\r\n{{ text_project_label }}\r\n		&lt;/td&gt;\r\n	&lt;/tr&gt;\r\n&lt;/table&gt;\r\n&lt;/body&gt;\r\n&lt;/html&gt;\r\n',
        'You have received an order.\r\n\r\nOrder Details\r\n\r\nOrder ID: {{ order_number }}\r\nDate Ordered: {{ date_added }}\r\nPayment Method: {{ payment_method }}\r\nShipping Method: {{ shipping_method }}\r\n\r\nEmail: {{ customer_email }}\r\nTelephone: {{ customer_telephone }}\r\n{{# customer_mobile_phone }}\r\nTelephone: {{ customer_mobile_phone }}\r\n{{/ customer_mobile_phone }}\r\n{{# customer_fax }}\r\nFax: {{ customer_fax }}\r\n{{/ customer_fax }}\r\nIP Address: {{ customer_ip }}\r\n\r\n{{# shipping_data }}\r\nShipping Address:\r\n{{ firstname }} {{lastname}}\r\n{{ company }} \r\n{{ address_1 }} \r\n{{ address_2 }}\r\n{{ city }} {{ postcode }}\r\n{{ zone }}\r\n{{ country }}\r\n{{/ shipping_data }}\r\n\r\n{{# payment_data }}\r\nPayment Address:\r\n{{ firstname }} {{lastname}} \r\n{{ company }}\r\n{{ address_1 }}\r\n{{ address_2 }}\r\n{{ city }} {{ postcode }}\r\n{{ zone }}\r\n{{ country }}\r\n{{/ payment_data }}\r\n\r\n\r\nProduct                                                 Model                             Price                  Quantity              Total\r\n{{# products }}\r\n					\r\n{{ name }}                                               {{ model }}                       {{ price }}            {{ quantity }}        {{ total }}\r\n   {{# option }}\r\n    - {{ name}} {{ value }} \r\n   {{/ option }}\r\n\r\n\r\n{{/ products }}\r\n{{# totals }}\r\n  {{ title }}  {{ text }}\r\n{{/ totals }}\r\n\r\n\r\n{{# comment }}\r\n	The comments for your order are:\r\n {{ comment }} \r\n{{/ comment }}\r\n\r\n{{# invoice }}\r\nTo view your order click on the link below:\r\n{{ invoice }}\r\n{{/ invoice }}\r\n\r\n{{ store_name }}\r\n{{ text_project_label }}',
        'store_name, order_number, store_url, logo_uri, logo_html, date_added, payment_method, shipping_method, customer_email, customer_telephone, customer_mobile_phone, customer_fax, customer_ip, shipping_data, payment_data, products, totals, comment, invoice,  text_project_label, order_total',
        '2019-12-23 13:20:39', '2019-12-23 13:20:39', NULL),
       (11, 1, 'admin_order_status_notify', 1, '', '{{ store_name }} - Order Update {{ order_id }}',
        'Order:  {{ order_id }} &lt;br/&gt;\r\nDate added: {{ date_added }} &lt;br/&gt;\r\nOrder status: {{ order_status_name }} &lt;br/&gt;\r\nInvoice: {{ invoice }}&lt;br/&gt;\r\n&lt;br/&gt;\r\n\r\nComment:&lt;br/&gt;\r\n{{ comment }}&lt;br/&gt;\r\n\r\n&lt;br/&gt;\r\n\r\nPlease reply to this email if you have any questions.\r\n',
        'Order:  {{ order_id }} \r\nDate added: {{ date_added }} \r\nOrder status: {{ order_status_name }} \r\nInvoice: {{ invoice }}\r\n\r\nComment:\r\n{{ comment }}\r\n\r\nPlease reply to this email if you have any questions.\r\n',
        'store_name, order_id, date_added, order_status_name, invoice, comment', '2019-12-23 13:50:03',
        '2019-12-23 13:50:03', NULL),
       (12, 1, 'admin_new_transaction_notify', 1, '', 'New transaction has been posted to your {{store_name}} account',
        'New transaction has been posted to your {{ store_name }} account in the amount of {{ amount }}. For more details, login to {{ store_name }} account',
        'New transaction has been posted to your {{ store_name }} account in the amount of {{ amount }}. For more details, login to {{ store_name }} account',
        'store_name, amount', '2019-12-23 13:55:42', '2019-12-23 13:57:13', NULL),
       (13, 1, 'admin_approval_email', 1, '', '{{ store_name}} - Your Account has been activated!',
        ...
        'Welcome and thank you for registering at {{ store_name }} \r\nYour account has now been created and you can log in by using your email address and password by visiting our website or at the following URL: \r\n{{ store_url }}\r\n\r\nOnce you logging in, you will be able to access, your wishlist, order history, printing invoices and editing your account information.\r\n\r\nThank you,\r\n {{ store_name}} \r\n\r\n{{text_project_label}}',
        'store_name, store_url, text_project_label, logo_uri, logo_html', '2019-12-23 14:17:58', '2019-12-23 14:20:29',
        NULL);
